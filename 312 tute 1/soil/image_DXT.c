...
/*	set this =1 if you want to use the covarince matrix method...
	...
	method fails for finding the largest eigenstd::vector	*/
		...
		float point[3], float direction[3] )
{
	...
	/*
		...
		For a given starting std::vector, the power method can
		...
		const unsigned char *const uncompressed )
{
	...
	/*	finding the max and min std::vector values	*/
	dot_max =
			(
	...
	)
{
	...
	compressed[6] = 0;
	compressed[7] = 0;
	/*	reconstitute the master color std::vectors	*/
